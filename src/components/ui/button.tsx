...
function Button({
  ...
  VariantProps<typeof buttonVariants> & {
    asChild?: boolean
    /** app-level convenience: shows spinner and disables interaction */
    loading?: boolean
  ...
  const resolvedVariant =
    ((VARIANT_ALIASES as Record<string, string>)[variant] ?? variant) as NonNullable<
      VariantProps<typeof buttonVariants>["variant"]
    >
  const resolvedSize =
    ((SIZE_ALIASES as Record<string, string>)[size] ?? size) as NonNullable<
