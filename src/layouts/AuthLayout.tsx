...
const ROUTE_CONTENT: Record<string, RouteHeroContent> = {
  ...
  "/auth/sign-up": {
    ...
    features: [
      { icon: TrendingUp, label: "Direct storefront listing and multi-variant catalogs" },
      { icon: Users, label: "Active fashion shoppers and verified order flow" },
      { icon: BadgeCheck, label: "Streamlined seller setup with Supabase Auth security" },
    ],
  },
  "/auth/forgot-password": {
    image: "/images/auth/forgot-password.jpg",
    tag: "Account Security",
    headline: "Bank-grade protection for your store",
  ...
  "/auth/reset-password": {
    ...
    sub: "Set a strong, private password to keep your store settings and banking settlements completely secure.",
    badgeText: "Security Update",
    features: [
      { icon: Lock, label: "Multi-factor authentication & encrypted storage" },
      { icon: ShieldCheck, label: "Role-based access protection for store teams" },
      { icon: CheckCircle2, label: "Instant session verification and token refresh" },
    ],
  },
  "/auth/verify-email": {
    image: "/images/auth/verify-email.jpg",
    tag: "Store Activation",
